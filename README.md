...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vya8xto.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vya8xto.containers.anotherwebservice.com/
...
```
git clone git@github.com:RaghulBE31/container-vya8xto.git
cd container-vya8xto
```
...
```
docker attach container-vya8xto
```
